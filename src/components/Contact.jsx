...
const LINKS = [
    {
        label: 'Email',
        value: 'abiruths29@gmail.com',
        href: 'mailto:abiruths29@gmail.com',
        icon: (
    ...
    {
        label: 'LinkedIn',
        value: 'linkedin.com/in/abiruth-s',
    ...
    {
        label: 'GitHub',
        value: 'github.com/abiruth29',
        href: 'https://github.com/abiruth29',
        icon: (
            <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
    ...
    return (
        <Section id="contact">
            ...
            <footer className="portfolio-footer">
                <p>Designed &amp; Built by <span className="text-gradient">Abiruth S</span> · {new Date().getFullYear()}</p>
            </footer>
        </Section>
    );
};
